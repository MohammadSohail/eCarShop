    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        <?php
          ...
          $result = $mysqli->query('SELECT * FROM workshop');
          if($result === FALSE){
            die(mysql_error());
          }
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
              ...
              echo '<p><strong>Workshop ID</strong>: '.$obj->id.'</p>';
              echo '<p><strong>Workshop Name</strong>: '.$obj->name.'</p>';
              echo '<p><strong>Location</strong>: '.$obj->location.'</p>';
